...
class Pre_Market:
    ...
    def start_pre_market_analysis(self):
        ...
        # set budget
        if available_cash >= 0 and available_cash < 300:
        ...
        for i in watchlist:
            ...
            key_levels = weekly_key_levels['key_levels'] + thirty_minute_key_levels['key_levels'] + one_minute_key_levels['key_levels']
            ...
            new_opportunity['Key Levels'] = no_duplicates.sort(key=lambda x: (-float('inf') if x is None else x), reverse=True)
